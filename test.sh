...
echo "PIPELINE_WORKSPACE contents:"
ls -1 $PIPELINE_WORKSPACE
echo "BUILD_ARTIFACTSTAGINGDIRECTORY contents:"
ls -1 $BUILD_ARTIFACTSTAGINGDIRECTORY
echo "SYSTEM_ARTIFACTSDIRECTORY is $SYSTEM_ARTIFACTSDIRECTORY"
echo "SYSTEM_ARTIFACTSDIRECTORY contents:"
